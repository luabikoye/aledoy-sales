...
<head>
    ...
    <title>Babyyo Admin Area | Orders</title>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <!-- ============================================================== -->
                        <li class=" in">
                            <form role="search" action="order.php" method="post" class="app-search d-none d-md-block me-3">
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo mydate($row['date_time']); ?></td>
                                            ...
                                            <td><a href="view-details.php?id=<?php echo base64_encode($row['id']); ?>" class="btn btn-success">Details</a> 
                                        
                                            <?php 
                                            if($row['payment_status'] == 'Pending')
                                            {
                                                ?>
                <a href="confirm-payment.php?id=<?php echo base64_encode($row['id']); ?>" onclick="return confirm('Are you sure you have received payment?')" class="btn btn-warning">Paid</a> 
                                            <?php 
                                            }
                                            ?>
