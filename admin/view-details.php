                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="row">
                                ...
                                <div class="item-list">
                                    ...
                                    <?php echo $row['email']; ?>
                                       ...
                                       <div class="item-list">
                                           ...
                                           <?php echo $row['address']; ?>,  <?php echo $row['city']; ?>,  <?php echo $row['state']; ?>
                                       </div>
                                ...
                                <?php
                                    $query_cat = "select * from cart where order_id = '$id'";
                                ...
                                ?>
                                        <div class="item-list">
                                        #<?php echo $row_cat['product_id']; ?> - <?php echo $row_cat['description']; ?> X <?php echo $row_cat['qty']; ?>,  <?php echo $row_cat['total_price']; ?>
                                       </div>
