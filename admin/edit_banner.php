                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <form action="proc_edit_banner.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <?php if($error) {
                                        ?>
                                    ...
                                    <div class="myfields">
                                        ...
                                        <input type="text" name="heading_name" value="<?php echo $row['heading']; ?>" class="form-control">
                                        <input type="text" name="subheading_name" value="<?php echo $row['sub_heading']; ?>" class="form-control">
