                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label>Product Title</label>
                                        <input type="text" name="product_title" value="<?php echo $row['title']; ?>" class="form-control"><br>
                                        <label>Category</label>
                                        <select name="cat" class="form-control" require>
                                        <option value="<?php echo $row['cat_id']; ?>"><?php echo get_category_name($row['cat_id']); ?></option>
                                            
                                            <?php
                                            $query_s = "select * from categories";
                                            ...
                                            ?>
                                            <option value="<?php echo $row_s['id']; ?>"><?php echo $row_s['cat_name']; ?></option>
                                            <?php
                                                }
                                            ?>
                                        </select><br>
                                        ...
                                        <label>Color</label>
                                        <input type="text" name="color" value="<?php echo $row['color']; ?>" class="form-control"><br>
                                        <label>Size</label>
                                        <input type="text" name="size" value="<?php echo $row['size']; ?>" class="form-control"><br>
                                        <label>Stock</label>
                                        <input type="text" name="stock" value="<?php echo $row['stock']; ?>" class="form-control"><br>
                                ...
                                <div class="col-md-4">
                                    <img src="<?php echo $row['image_1']; ?>" style="width:200px;"><br> 
                                    <label>Change Image</label>
                                        <input type="file" name="product_image" class="form-control"><br>
                                    <img src="<?php echo $row['image_2']; ?>" style="width:200px;"><br> 
                                    <label>Change Image</label>
                                        <input type="file" name="product_image2" class="form-control"><br>
                                    <img src="<?php echo $row['image_3']; ?>" style="width:200px;"><br> 
                                    <label>Change Image</label>
