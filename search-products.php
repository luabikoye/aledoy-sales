...
if ($search_text != '') {
    $where = "or title like '%$search_text%'";
}
if ($search_category != '') {
    $where2 = "or cat_id like '%$search_category%'";
}
// $min_price = $_POST['0-10000'];
// $max_price = $_POST['10000-20000'];

// if ($min_price != '') {
//     $whereprice = "price = '$min_price'";
// }
// if ($search_category != '') {
//     $whereprice2 = "or cat_id like '%$search_category%'";
// }
            ...
            <div class="row">
                <div class="col-md-12">
                     ...
                     <?php
                                 ...
                                 $search = "select * from products where id ='' $where $where2";

            $result_search = mysqli_query($conn,$search);                             $num_text = mysqli_num_rows($result_search);
            for ($i=0; $i < $num_text; $i++) { 
                $row_pr = mysqli_fetch_array($result_search)
